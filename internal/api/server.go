...
func NewServerWithAddress(
	...
	if cp != nil {
		...
		authed.Handle("POST /api/v1/platforms/{id}/leases/actions/generate-by-node", HandleGenerateLeasesByNode(cp))
		authed.Handle("POST /api/v1/platforms/{id}/leases/actions/generate-by-egress-ip", HandleGenerateLeasesByEgressIP(cp))
